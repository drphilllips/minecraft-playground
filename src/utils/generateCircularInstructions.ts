import type { BlueprintCircularInstructions, BlueprintCircularStepInstruction } from "../types/blueprintInstruction";
...
export default function generateCircularInstructions(grid: CircularCellType[][], cellStyling: CircularCellStyling, entity: "circle" | "dome-level"): BlueprintCircularInstructions {
  ...
  const stepInstructions: BlueprintCircularStepInstruction[] = []
